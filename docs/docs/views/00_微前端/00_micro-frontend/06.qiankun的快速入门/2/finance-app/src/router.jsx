...
const routes = [
  {
    ...
    children: [
      ...
      {
        // [路由处理2:] 财务子应用配置 /finance basename 后，内部路由只写 basename 后面的部分。
        path: "/bills",
        element: <BillsView />,
      },
      {
...
export function createFinanceRouter() {
  return createBrowserRouter(routes, {
    ...
    // [路由处理2:] React Router 冲突修复演示：默认先注释，让学生先看到 React Router 覆盖 history.state 的问题。
    // 讲解完问题后，再打开下面这一行，把带 history 代理的 window 交给 React Router。
