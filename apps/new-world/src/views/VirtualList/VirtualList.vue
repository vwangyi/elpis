...
function getEndIndex(scrollTop: number, clientHeight: number) {
  return Math.ceil(clientHeight / 70) + getStartIndex(scrollTop)
}
...
function handleScroll(e: unknown) {
  ...
  let endIndex = getEndIndex(scrollTop, clientHeight)
