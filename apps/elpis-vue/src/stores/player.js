    ...
    () => {
      ...
      function playVideo(
        ...
        // 播放器不为空
          ...
          window.playerService?.isPlaying()
          ...
          if (
            ...
            switch (
              ...
              case 0:
                ...
                window.playerService?.changePlayerCore(
                  'amt'
                );
                break;
              case 1:
      ...
      function seekTo(
        ...
        return window?.playerService?.seekTo(
          position
        );
      }
      /* 获取播放器播放状态 */
      function playerStatus() {
        ...
        if (
          ...
          window?.playerService?.isPause()
        ) {
          //播放器暂停状态
          staueRes = 1; // 表示 暂停
        } else if (
          window?.playerService?.isStop()
        ) {
          //播放器停止状态
          staueRes = 2; // 表示 停止播放
        }
      ...
      /* 设置播放器窗口大小 */
      function setPlayerLocationAndSize(
        w,
        h,
        l,
        t
        ...
        let screen =
          window.androidInterfaceService?.getScreenInfo();
        let screenWidth =
          parseInt(
            screen.split(
              'x'
        ...
        ScalingRatio =
          1080 / screenHeight; // 1080/720=1.5    1080/2160=0.5
        // 判断是否设置全屏
        isFullScreen =
          w === 1920 &&
          h === 1080
      ...
      function setPlaySpeed(
        ...
        return window?.playerService?.setPlaySpeed(
          speed
        );
      }
