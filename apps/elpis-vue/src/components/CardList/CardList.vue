...
<template>
  <div class="main-content hide-scrollbar">
    ...
    <elpis-dialog v-model:open="openDialog">
      <div style="width: 1100px; height: calc(100vh - 40px); background-color: aliceblue; color: red">
        <elpis-editor v-if="openDialog" type="update" :data="categoryItem"></elpis-editor>
      </div>
    </elpis-dialog>
  </div>
</template>
